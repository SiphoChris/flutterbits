...
<Callout title="Coming from Tailwind / shadcn">
  These are the same semantic CSS variables [shadcn uses](https://ui.shadcn.com/docs/theming) —
...
The complete [Tailwind v4 palette](https://tailwindcss.com/docs/colors) is baked in as `const`
