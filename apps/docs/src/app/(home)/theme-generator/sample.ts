/// A complete real tweakcn Tailwind-v4 export (the "Claude" theme, OKLCH) used by
/// the generator page's "Try an example" button. Kept verbatim so a first-time
/// visitor sees a full, real conversion (32 colors + radius + shadows + fonts)
/// without having to find a theme to paste. It is the same theme as the
/// `__fixtures__/claude.oklch.css` golden input.
export const SAMPLE_THEME = `:root {
