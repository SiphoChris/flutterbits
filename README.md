...
1. **Animated theming (`FwAnimatedTheme`)** — the last engine module: an implicitly‑animated widget that tweens between `FwTokens` via `lerp` over a duration/curve (Material‑free).
